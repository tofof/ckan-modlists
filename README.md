...
6. Disable Kopernicus replacing your solar panels (at least until they integrate [this PR](https://github.com/Kopernicus/Kopernicus/pull/364)): in `Kerbal Space Program\GameData\Kopernicus\Config\SolarPanels.cfg` comment out line 18 so that it reads `//        @name = KopernicusSolarPanel`
