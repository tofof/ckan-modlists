...
* **Alternate Resource Panel** -- better than the stock resource display, can show countdown time to resource exhaustion etc
...
* **Resonant Orbit Calculator** --- used for putting satellites into an identical orbit, spaced evenly along it
